...
CREATE TABLE `agenti` (
  ...
  `telefon` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `slika` varchar(1000) COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id`)
...
LOCK TABLES `agenti` WRITE;
/*!40000 ALTER TABLE `agenti` DISABLE KEYS */;
INSERT INTO `agenti` VALUES (1,'Niko Nikic','niko@nikic.com','033283929','https://media.istockphoto.com/id/1300972574/photo/millennial-male-team-leader-organize-virtual-workshop-with-employees-online.jpg?s=612x612&w=0&k=20&c=uP9rKidKETywVil0dbvg_vAKyv2wjXMwWJDNPHzc_Ug='),(2,'Svako Svakic','svako@svakic.com','033283929','https://media.istockphoto.com/id/1300512215/photo/headshot-portrait-of-smiling-ethnic-businessman-in-office.webp?b=1&s=170667a&w=0&k=20&c=TXCiY7rYEvIBd6ibj2bE-VbJu0rRGy3MlHwxt2LHt9w=');
/*!40000 ALTER TABLE `agenti` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `korisnici` VALUES (1,1,'Admin Adminic','admin@admin.com','$2b$10$5zFEuLSSq2q72XqjMx0Hkuox2oIOfWgKLFYUYmL7YWQrLij5aCJie'),(2,0,'Elvis Hodzic','elvis@gmail.com','$2b$10$9jKxrdcBVGGZLJI/H/T3kOs0wDt8pDBLEnJOYw23NtA3C3hK9R75W'),(4,0,'Test','test@test.com','$2b$10$ke4K/tIzkkyjluyHuX7JDeJUxCLdsqv4ihOlEieAAseXPjjgem6qq'),(5,0,'Dzana','dzana@gmail.com','$2b$10$TYImkvdeAEn2ClAByU8JO.1knMDF60q3vrIH7y59FG8.w/bPB1q92');
...
CREATE TABLE `lokacije` (
  `id` int NOT NULL AUTO_INCREMENT,
  `filijala` varchar(30) COLLATE utf8mb4_general_ci NOT NULL,
  `adresa` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `telefon` varchar(12) COLLATE utf8mb4_general_ci NOT NULL,
  `email` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `lokacije` VALUES (1,'Sarajevo','Drinska bb','033123123','nekretnine_sa@gmail.com'),(3,'Tuzla','Kotromaniceva bb','033321321','nekretnine_tz@gmail.com'),(5,'Banja Luka','Dobojska bb','033322321','nekretnine_bl@gmail.com');
...
CREATE TABLE `nekretnine` (
  `id` int NOT NULL AUTO_INCREMENT,
  `naziv` varchar(200) COLLATE utf8mb4_general_ci NOT NULL,
  `opis` varchar(2000) COLLATE utf8mb4_general_ci NOT NULL,
  `vrsta` varchar(15) COLLATE utf8mb4_general_ci NOT NULL,
  `kvadratura` int NOT NULL,
  `struktura` varchar(11) COLLATE utf8mb4_general_ci NOT NULL,
  `sprat` int NOT NULL,
  `novogradnja` tinyint(1) NOT NULL,
  `renoviran` tinyint(1) NOT NULL,
  `lift` tinyint(1) NOT NULL,
  `garaza` tinyint(1) NOT NULL,
  `grijanje` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `cijena` double NOT NULL,
  `slika` varchar(5000) COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id`)
...
LOCK TABLES `nekretnine` WRITE;
/*!40000 ALTER TABLE `nekretnine` DISABLE KEYS */;
INSERT INTO `nekretnine` VALUES (1,'Dvosoban stan - Novo Sarajevo - Dolac Malta - 55 m2','Stan je površine 73 m2. Sastoji se od dnevnog boravka koji je povezan sa trepezarijom i kuhinjom, dvije spavaće sobe, hodnika, kupatila, wc-a te balkona. Isti posjeduje parking mjesto ispred zgrade, koje je osigurano rampom te video nadzorom. Stan se nalazi na petom spratu u zgradi koja broji 6 spratova, dvostrano orijentisan, istok/zapad te sunčan tokom čitavnog dana, sa otvorenim pogledom.','stan',73,'trosoban',4,1,0,1,0,'plin',330000,'https://trust.ba/wp-content/uploads/2021/01/IMG_4823-1500.jpg'),(2,'Kvalitetna kuća i dvorište, Kotorac, Ilidža','Prodaje se kvalitetno građena kuća, bruto kvadrature cca. 140 m2, spratnosti P+1 sa garažom i lijepo uređenim i prostranim dvorištem na parceli uknjižene površine 724 m2 u mirnom dijelu naselja Donji Kotorac, Ilidža.\r\n\r\n\r\n\r\nPrema informacijama vlasnika kuća je izgrađena 2018. godine i redovno je održavana, a prilikom gradnje su korišteni kvalitetni građevinski materijali.\r\n\r\nU prizemlju se nalaze dvije zasebne stambene jedinice od kojih se jedna sastoji od dnevnog boravka, spavaće sobe, kupatila i kuhinje a druga od dnevnog boravka, kupatila i kuhinje.\r\n\r\nBudući vlasnici imaju mogućnost spajanja ove dvije stambene jedinice čime bi se uz manji građevinski poduhvat ofomila veća stambena funkcionalna stambena cjelina.\r\n\r\nNa prvoj etaži su smješteni dnevni boravak sa izlazom na terasu, dvije spavaće sobe, kuhinja i ostava.\r\n\r\n\r\n\r\nEtaže su povezane kvalitetnim vanjskim stepenicama tako da se mogu koristiti kao zasebne stambene jedinice.\r\n\r\nIspred su garaža i betonirani prostor koji se može koristiti kao parking za nekoliko vozila, a pristup je omogućen sa asfaltirane pristupne ceste.\r\n\r\nKuća je okružena prostranim dvorištem sa lijepo uređenim travnatim površinama i obiljem zelenila kao i mnoštvom stabala voća. Obzirom na ravan teren i samu uređenost dvorišta koje budućim vlasnicima omogućava boravak u potpunoj privatnosti ove nekretnina predstavlja odličnu priliku za one koji žele miran porodični život izvan gradske buke nadomak svih potrebnih sadržaja.\r\n\r\nOno što ovu nekretninu čini još atraktivnijom jeste okruženje u kojem je sagrađeno više modernih stambenih objekata.','kuca',200,'petosoban',2,0,0,0,1,'pelet',240000,'https://cf.bstatic.com/xdata/images/hotel/max1024x768/225339233.jpg?k=8905fc88b0b809a6bb62fa4c735544b08133b44784f1ccd18a7921cdc76ceee5&o=&hp=1'),(4,'Luksuzan petosoban stan u novogradnji Vraca, 144m2','Stan je površine 144 m2 + terasa i nalazi se na prizemlju stambene zgrade. Sastoji se od dvije etaže i po strukturi je petosoban.\r\n\r\nSastoj se iz ulaznog hola sa stepeništem, prostranog dnevnog boravka, kuhinje sa trpezarijom, četiri spavaće sobe, tri kupatila i ostave. Iz dnevnog boravka i iz dvije spavaće sobe se izlazi na terase sa prelijepim pogledom na Sarajevo. Zgrada u kojoj se stan nalazi odikuje se prvoklasnim materijalima gradnje, kao i vrhunskom termičkom izolacijom sa uštedom energije kako za grijanje zimi tako i hlađenje ljeti. Pod u stanu je parket i keramika. Vanjska stolarija je ALU (SCHUCO). Ulazna vrata su protivpožarna i protuvprovalna. Objektu pripada ograđeno dvorište, obezbijeđeno video nadzorom, koje služi kao parking za stanare. Također budući stanari imaju mogućnost koritešnja dječijeg igrališta kao i dijela za uživanje i roštiljanje.\r\n','stan',73,'trosoban',4,1,0,1,0,'plin',330000,'https://trust.ba/wp-content/uploads/2020/10/IMG_4091-1500.jpg'),(5,'Trosoban namješten stan Pofalići-Sarajevo Tower, 83m2, #79\r\n','Stan je površine 83,5 m2 i nalazi se na 24. spratu stambene zgrade sa osam liftova. Po strukturi je trosoban.\r\nSastoji se iz hodnika, dnevnog boravka sa kuhinjom, trpezarijom i izlazom na balkon, kupatila i dječije spavaće sobe sa izlazom na balkon i master spavaće sobe sa kupatilom i izlazom na balkon. Stan je u novogradnji Sarajevo Tower. Vanjska stolarija je PVC, dok je unutrašnja drvena. Pod je parket i keramika. Ulazna vrata su blindirana. Grijanje je centralno gradsko, po potrošnji. Orijentacija stana je istok. Nalazi na veoma atraktivnoj lokaciji, u sklopu samog objekta planiran je tržni centa, u neposrednoj blizini su gradski prijevoz, mnogi drugi shoping centri, KAMPUSA… kao i drugi neophodni sadržaji.','kuca',200,'petosoban',2,0,0,0,1,'pelet',240000,'https://www.nekretnine-myspace.com/wp-content/uploads/2022/03/21t%C5%BE-1110x650.jpg'),(6,'Četverosoban stan u novogradnji Breka, 104m2','Stan je površine 104 m2 i nalazi se na I spratu stambene zgarde sa liftom. Po strukturi je četverosoban.\r\n\r\nSastoji se iz hodnika, dnevnog boravka sa izlazom na balkon, kuhinje sa trpezarijom i izlazom na drugi balkon, manjeg kupatila, tri spavaće sobe i većeg kupatila. Stan se nalazi u gradnji iz 2010. godine. Pod je parket i keramika. Vanjska stolarija drvena kao i unutrašnja. Ulazna vrata su drvena sa sigurnosnom bravom. Grijanje je etažno plinsko. Ortjentacija stana je trostrana (Zapad – Sjever – Istok). Stan posjeduje podrumsku prostoriji kao i parking mjesto ispred zgrade. Nalazi se na veoma lijepoj i mirnoj lokaciji sa otvorenim pogledom i prodaje se namješten.','stan',73,'trosoban',4,1,0,1,0,'plin',330000,'https://ontime.ba/wp-content/uploads/2022/04/DSC_1073A.jpg'),(7,'Dvosoban renoviran stan sa garažom Stari Grad','Stan je površine 52m2 i nalazi se na I spratu u manjoj stambenoj zgradi, ujedno i zadnji sprat. Po strukturi stan je dvosoban.\r\n\r\nSastoji se iz hodnika, dnevnog boravka, kuhinje sa trpezarijom, spavaće sobe i kupatila. Stan je kompletno renoviran 2015. godine (zamijenjene instalacije, stolarija). Krov je rađen prije 7 godina. Vanjska i unutrašnja stolarija je drvena. Pod je parket i keramika. Grijanje je etažno plinsko. Toplotna izolacija stana je odlična. Orijentacija stana je dvostrana (sjever-jug). Iznad stana je tavanski prostor. Stan se prodaje namješten (bez trepezarijskog stola sa stolicama i ličnih stvari). Uz stan se dobije i garaza 15,5m2 (vanknjižno vlasništvo).','kuca',200,'petosoban',2,0,0,0,1,'pelet',240000,'https://d4n0y8dshd77z.cloudfront.net/listings/51899821/lg/IMG-0669-4b2a3e534889.jpg'),(8,'Jednoiposoban namješten stan novogradnja Vogošća, 35m2','Stan je površine 35 m2 i nalazi se na II spratu stambene zgrade sa liftom. Po strukturi je jednoiposoban.\r\n\r\nSastoji se iz hodnika, dnevnog boravka sa kuhinjom, trpezarijom i izlazom na balkon, spavaće sobe i kupatila. Vanjska stolarija je PVC, unutrašnja stolarija je drvena. Pod je parket i keramika. Grijanje u stanu je na struju konvektorima. Ulazna vrata su blindirana. Stan se nalazi u novogradnji i prodaje se namješten.','stan',73,'trosoban',4,1,0,1,0,'plin',330000,'https://d4n0y8dshd77z.cloudfront.net/listings/54621050/lg/img-1691087691-9c60a1c3f3ff.jpg'),(9,'Trosoban namješten stan Ciglane, 90m2','Stan je površine 90 m2 i nalazi se na IV spratu stambene zgrade sa liftom. Po strukturi je trosoban.\r\n\r\nSastoji se iz hodnika, dnevnog boravka sa izlazoma na balkon, trpezarije, kuhinje, toaleta, degažmana, dvije spavaće sobe (jedna je sa izlazom na drugi balkon) i ostave. Vanjska stolarija je drvena, kao i unutrašnja. Pod je laminat i keramika. Ulazna vrata su blindirana. Grijanje je centralno gradsko. Stan je na veoma lijepoj lokaciji, sa otvorenim pogledom i iznajmljuje se namješten.','kuca',200,'petosoban',2,0,0,0,1,'pelet',240000,'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSMd_9kWlvNz9Q61qudBbR2zj5yQ-Dz-jdPPw&usqp=CAU');
/*!40000 ALTER TABLE `nekretnine` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2023-09-06 18:07:17',NULL),('diagnostics.include_raw','OFF','2023-09-06 18:07:17',NULL),('ps_thread_trx_info.max_length','65535','2023-09-06 18:07:17',NULL),('statement_performance_analyzer.limit','100','2023-09-06 18:07:17',NULL),('statement_performance_analyzer.view',NULL,'2023-09-06 18:07:17',NULL),('statement_truncate_len','64','2023-09-06 18:07:17',NULL);
...
CREATE TABLE `upiti` (
  `id` int NOT NULL AUTO_INCREMENT,
  `email` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `broj_telefona` varchar(12) COLLATE utf8mb4_general_ci NOT NULL,
  `poruka` varchar(500) COLLATE utf8mb4_general_ci NOT NULL,
  `idNekretnine` int NOT NULL,
  PRIMARY KEY (`id`)
...
LOCK TABLES `upiti` WRITE;
/*!40000 ALTER TABLE `upiti` DISABLE KEYS */;
INSERT INTO `upiti` VALUES (4,'test@test.com','4980298402','rjglaeijknzkvnmkmv zd',1),(13,'elvis@gmail.com','065850179','Upit test',2);
/*!40000 ALTER TABLE `upiti` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-09-15 10:15:28
